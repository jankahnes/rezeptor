<template>
  <div
    class="action-card action-card-padding flex flex-col relative"
    :class="{ '!bg-primary-20/80 overflow-hidden': formalizationLoading }"
  >
    <div class="flex justify-between items-center w-full mb-4">
      <ComponentHeader title="INGREDIENTS" v-if="!hideHeader" />
    ...
    <div class="flex-1 py-2">
      <div
        class="max-w-120 space-y-4 select-none"
      ...
      >
        ...
        >
          ...
          <ul
            class="grid grid-cols-[max-content_max-content_1fr] gap-x-1 gap-y-4 ml-2"
            role="list"
          >
            <li
            ...
            >
              <div class="flex items-center justify-center">
                <input
                  ...
                  class="w-4 h-4 rounded appearance-none bg-primary-20 outline outline-gray-300"
                />
              </div>
              <Transition name="fade-slide" mode="out-in">
                <span
