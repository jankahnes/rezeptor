<template>
  <div class="flex justify-center w-full">
    <div class="pt-18 w-full max-w-[900px] flex flex-col gap-4 items-start">
      <textarea
        v-model="baseRecipe.title"
        v-auto-resize
        rows="1"
        placeholder="✍️ New Recipe"
        class="md:ml-4 min-w-[40%] font-bold text-3xl border-box bg-primary-20/70! rounded-xl p-2 outline-none resize-none overflow-hidden h-auto break-words scrollbar-hide"
      />
      ...
      <textarea
        ...
        class="md:ml-4 min-w-[60%] bg-primary-20/70! rounded-xl p-2 outline-none resize-none overflow-hidden h-auto break-words scrollbar-hide text-sm"
      ></textarea>
