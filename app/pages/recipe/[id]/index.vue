<template>
  <div>
    ...
    >
      ...
      <div
        class="mx-auto max-w-screen-lg flex flex-col gap-2 bg-primary-10 text-gray-800 p-8 rounded-xl border border-gray-200 relative z-10"
        :class="
          hasPicture ||
