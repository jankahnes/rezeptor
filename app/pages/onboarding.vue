        ...
        <div class="p-2 sm:p-8 max-w-2xl w-full">
          ...
          <div class="flex justify-between items-center mt-8">
            <button
              ...
              class="px-6 py-3 bg-white/10 hover:bg-white/30 disabled:bg-white/10 disabled:opacity-50 rounded-full text-gray-800 font-medium transition-all duration-200 border border-gray-800/30"
            ...
            <button
              @click="nextStep"
              :disabled="!canProceed"
              class="px-8 py-3 bg-white/20 hover:bg-white/30 disabled:opacity-50 rounded-full text-gray-800 font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
