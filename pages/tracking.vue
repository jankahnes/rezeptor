<template>
  <div class="mx-auto space-y-6 max-w-screen-md m-4 p-4 pb-20">
    ...
    >
      <button
        ...
        :class="{
          'bg-primary! text-white hover:bg-primary-dark': hasUnsavedChanges,
    ...
    <div class="flex flex-col gap-2">
      <div
        ...
        class="flex flex-col gap-2 p-4 shadow-none! bg-gray-50 rounded-xl"
        :class="{ 'bg-primary-50/70!': meal.recipe_id !== undefined }"
      >
        <div
        ...
        >
          <div class="relative inline-block">
            ...
            <input
              ...
              class="text-lg font-bold focus:outline-none bg-gray-100! rounded-md py-2 px-3 absolute inset-0 w-full"
              @click.stop
