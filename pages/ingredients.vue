<template>
  <div
    class="sticky top-18 xm:top-22 bg-gray-50 w-full sm:px-12 px-2 py-5 space-y-4 z-10"
  >
    <div class="flex items-center gap-4">
      <div
        class="flex bg-white border-2 border-black px-2 text-2xl font-extrabold shadow-[2px_2px_0_0_rgba(0,0,0,1)]"
      >
        RDB
      </div>
  ...
  <div class="sm:mx-12 mx-2 h-[65vh] border-4 border-double p-3">
    <div v-if="currentView != 0" class="flex justify-between">
      <button
        ...
        @click="currentView = 0"
      >
        <span class="select-none material-symbols-outlined"> arrow_back </span>
      </button>
...
const searchResults = ref([
  ...
  {
    name: 'Grilled Chicken Breasttttttttttttttttt',
    kcal: 165,
    carbs: 0.0,
    protein: 31.0,
    fat: 3.6,
