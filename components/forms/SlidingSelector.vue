<template>
  ...
  >
    ...
    >
      ...
      >
        <div
          class="text-center cursor-pointer text-xl font-bold border-2 bg-[#DBFCE7] border-[#98E9AF] text-[#008236] rounded-lg shadow-md transition-all duration-300 ease-out"
        >
          {{ choice }}
        </div>
      </div>
