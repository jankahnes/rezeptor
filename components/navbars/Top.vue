  ...
  <nav class="fixed w-full z-30 bg-main mask-fade-bottom">
    ...
    >
      ...
      <div class="xm:flex hidden items-center gap-2">
        <NuxtLink
          to="/recipes"
          class="button text-primary font-bold flex items-center justify-center px-2 py-1 gap-1"
      ...
      <div v-if="auth.isUser()" class="flex gap-2">
        <NuxtLink
          ...
          class="button text-primary font-bold flex items-center justify-center gap-1"
        >
      ...
      <div v-else class="flex gap-2">
        <NuxtLink
          to="/login"
          class="button text-primary font-bold flex items-center justify-center px-3 py-2 gap-1"
        >
          Login
        </NuxtLink>
        <NuxtLink
          to="/onboarding"
          class="button !bg-primary text-white font-bold flex items-center justify-center px-3 py-2 gap-1"
        >
          Sign Up
        </NuxtLink>
      </div>
